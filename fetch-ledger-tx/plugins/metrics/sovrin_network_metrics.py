...
class main(plugin_collection.Plugin):
    ...
    def __init__(self, mlog: bool = False, csv: bool = False, gauth_json: str = None, file_name: str = None, worksheet_name: str = None, batchsize: int = None):
    ...
    def parse_args(self, parser, argv=None, status_only: bool = False):
        ...
        parser.add_argument("--csv", action="store_true", help="csv")
    ...
    def find_last(self):
        ...
        if self.csv:
            ...
            with open(path + '/CSVlog.txt') as csv_file:
    ...
    def metrics(self, maintxr_response, network_name, txn_range):
        ...
        for txn in maintxr_response:
            ...
            path = os.path.dirname(__file__)
            with open(path + '/CSVlog.txt','a') as csv_file:
                employee_writer = csv.writer(csv_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_NONE)
